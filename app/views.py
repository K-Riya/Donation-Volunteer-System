    ...
    def post(self,request):
        ...
        try:
            ...
            if user:
                ...
                messages.warning("Invalid username and password")
        except:
    ...
    def post(self,request):
        ...
        if form1.is_valid() & form2.is_valid():
            ...
            # Process the file
                ...
                return HttpResponseBadRequest("Userpic not provided. Please fill form again.")
            
            try:
                user = User.objects.create_user(first_name=fn,last_name=ln,username=us,password=pwd,email=em)
    ...
    def post(self,request):
        ...
        if form1.is_valid() & form2.is_valid():
            ...
            # Process the file
                ...
                return HttpResponseBadRequest("Idpic not provided. Please fill form again.")
    ...
    def post(self,request):
        ...
        if form.is_valid():
            ...
            try:
                ...
                messages.warning(request,"Failed to Save Donation")
        return render(request, "donate-now.html",locals())
...
def index_volunteer(request):
    ...
    totalDonationDellivered = Donation.objects.filter(volunteer=volunteer,status="Donation Delivered Successfully").count()
