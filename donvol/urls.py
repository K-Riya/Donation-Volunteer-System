...
urlpatterns = [
    ...
    path("password-reset-completed/",auth_views.PasswordResetCompleteView.as_view(template_name = 'password_reset_complete.html'),name='password_reset_complete'),
    ...
    # view details
    path("accepted-donationdetail/<int:pid>",views.accepted_donationdetail.as_view(),name="accepted_donationdetail",),
    path("view-volunteerdetail/<int:pid>",views.view_volunteerdetail.as_view(),name="view_volunteerdetail",),
    path("view-donordetail/<int:pid>", views.view_donordetail, name="view_donordetail"),
    path("view-donationdetail/<int:pid>",views.view_donationdetail.as_view(),name="view_donationdetail",),
    ...
    path("donationcollection-detail/<int:pid>",views.donationcollection_detail.as_view(),name="donationcollection_detail",),
